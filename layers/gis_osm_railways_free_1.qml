...
<qgis simplifyDrawingTol="1" labelsEnabled="0" maxScale="0" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" version="3.4.9-Madeira" styleCategories="AllStyleCategories" simplifyLocal="1" minScale="1e+8" simplifyMaxScale="1" simplifyDrawingHints="1" readOnly="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" type="RuleRenderer">
    <rules key="{94aeb3d6-c3b0-4db9-95af-3ed007c47cd1}">
      <rule key="{a40419c4-6c15-42c1-8f6a-638a1dec745e}" symbol="0">
        <rule scalemaxdenom="5000" key="{a1313ee4-dcdf-4247-9881-9498f2a3f695}" label="0 - 5000" symbol="1"/>
        <rule scalemaxdenom="10000" key="{703693b5-4ae2-4e70-bf1c-cd5bdff4f255}" label="5000 - 10000" symbol="2" scalemindenom="5000"/>
        <rule scalemaxdenom="25000" key="{200197aa-8102-42bd-8347-acf3a7262261}" label="10000 - 25000" symbol="3" scalemindenom="10000"/>
        <rule scalemaxdenom="50000" key="{c092859a-081a-4beb-bfcb-8881874e2257}" label="25000 - 50000" symbol="4" scalemindenom="25000"/>
        <rule scalemaxdenom="100000" key="{75f215bc-8aee-41ed-ac2f-13d0f095e70c}" label="50000 - 100000" symbol="5" scalemindenom="50000"/>
        <rule scalemaxdenom="250000" key="{4e60330d-0d4f-4f51-a5ab-89caccd0581f}" label="100000 - 250000" symbol="6" scalemindenom="100000"/>
        <rule key="{23e1021f-9d83-496a-889d-1e3b294ae524}" label="250000 - 0" symbol="7" scalemindenom="250000"/>
      </rule>
    </rules>
    <symbols>
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="outlineColor" type="Map">
                  ...
                  <Option name="expression" value="darker(  project_color( 'background'), @darker_factor )" type="QString"/>
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="outlineColor" type="Map">
                  <Option name="active" value="true" type="bool"/>
                  <Option name="expression" value="lighter(  project_color( 'background'), @lighter_factor )" type="QString"/>
                  <Option name="type" value="3" type="int"/>
                </Option>
              </Option>
              <Option name="type" value="collection" type="QString"/>
  ...
  <customproperties>
    ...
    <property key="variableNames">
      <value>darker_factor</value>
      <value>lighter_factor</value>
    </property>
