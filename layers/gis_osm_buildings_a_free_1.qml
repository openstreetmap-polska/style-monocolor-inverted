...
<qgis simplifyDrawingTol="1" labelsEnabled="0" maxScale="0" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" version="3.4.9-Madeira" styleCategories="AllStyleCategories" simplifyLocal="1" minScale="1e+8" simplifyMaxScale="1" simplifyDrawingHints="1" readOnly="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" type="RuleRenderer">
    <rules key="{4fd88eb6-68c0-4d39-a829-946b5fe810ee}">
      <rule key="{aab68c42-70ce-488d-ac37-afb6c61c0d58}" symbol="0">
        <rule scalemaxdenom="10001" key="{693acb8b-b809-4e89-aa61-2f2b3eeee629}" label="0 - 10000" symbol="1"/>
        <rule scalemaxdenom="25001" filter="$area >1000" key="{f24ebd96-acf9-439c-b566-d76715bff739}" label="10000 - 20000" symbol="2" scalemindenom="10000"/>
      </rule>
    </rules>
    <symbols>
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="fillColor" type="Map">
                  ...
                  <Option name="expression" value="lighter(project_color('background'),130)" type="QString"/>
                  <Option name="type" value="3" type="int"/>
                </Option>
                <Option name="outlineColor" type="Map">
                  <Option name="active" value="true" type="bool"/>
                  <Option name="expression" value="darker(project_color('background'),130)" type="QString"/>
                  <Option name="type" value="3" type="int"/>
                </Option>
              </Option>
