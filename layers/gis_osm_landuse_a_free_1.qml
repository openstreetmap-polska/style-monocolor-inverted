...
<qgis simplifyDrawingTol="1" labelsEnabled="0" maxScale="0" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" version="3.4.9-Madeira" styleCategories="AllStyleCategories" simplifyLocal="1" minScale="1e+8" simplifyMaxScale="1" simplifyDrawingHints="1" readOnly="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" type="RuleRenderer">
    <rules key="{33d8d817-d422-46a7-a195-d5eb24ca53dd}">
      <rule filter="&quot;fclass&quot; in ( 'allotments', 'residential','retail')" key="{0083da0f-f4e0-4947-aaee-a252d64065c8}" label="residential" symbol="0"/>
      <rule filter="&quot;fclass&quot; in ( 'commercial', 'industrial')" key="{b295277a-fd4d-42b2-9b95-ee87577d3a2d}" label="commercial" symbol="1"/>
      <rule filter="&quot;fclass&quot; in ('forest','orchard','park')" key="{36ab0cb8-fd06-4e57-acff-98da14c4124e}" label="forest" symbol="2"/>
    </rules>
    <symbols>
      <symbol name="0" clip_to_extent="1" force_rhr="0" alpha="1" type="fill">
        <layer enabled="1" pass="0" locked="0" class="SimpleFill">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="89,214,16,255" k="color"/>
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="fillColor" type="Map">
                  ...
                  <Option name="expression" value="darker(  project_color( 'background'),105)" type="QString"/>
                  <Option name="type" value="3" type="int"/>
                </Option>
                <Option name="outlineColor" type="Map">
                  <Option name="active" value="true" type="bool"/>
                  <Option name="expression" value="darker(  project_color( 'background'),110)" type="QString"/>
                  <Option name="type" value="3" type="int"/>
                </Option>
              </Option>
      ...
      <symbol name="1" clip_to_extent="1" force_rhr="0" alpha="1" type="fill">
        <layer enabled="1" pass="0" locked="0" class="SimpleFill">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="206,116,102,255" k="color"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                ...
                <Option name="outlineColor" type="Map">
                  <Option name="active" value="true" type="bool"/>
                  <Option name="expression" value="darker(  project_color( 'background'),115)" type="QString"/>
                  <Option name="type" value="3" type="int"/>
                </Option>
              </Option>
              <Option name="type" value="collection" type="QString"/>
      ...
      <symbol name="2" clip_to_extent="1" force_rhr="0" alpha="1" type="fill">
        <layer enabled="1" pass="0" locked="0" class="SimpleFill">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="226,112,200,255" k="color"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                ...
                <Option name="outlineColor" type="Map">
                  <Option name="active" value="true" type="bool"/>
                  <Option name="expression" value="darker(  project_color( 'background'),120)" type="QString"/>
                  <Option name="type" value="3" type="int"/>
                </Option>
              </Option>
              <Option name="type" value="collection" type="QString"/>
